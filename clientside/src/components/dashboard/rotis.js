...
function Roti() {
  ...
  const [message, setMessage] = useState('');
    ...
    <div className="row">
    {[
      {id:'$2', name: 'Pulka', img: 'assets/pulka.jpg',price:150 },
      { id:'$2',name: 'Paratha', img: 'assets/naan.webp',price:200 },
      { id:'$3',name: 'Jowar roti', img: 'assets/Jowar-Rotis-3.jpg',price:220 },
      { id:'$4',name: 'Chapathi', img: 'assets/chapathi.jpg',price:250},
    ].map((outlet) => (
